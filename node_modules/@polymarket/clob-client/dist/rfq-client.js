...
import { DELETE, GET, POST, parseRfqQuotesParams, parseRfqRequestsParams, } from "./http-helpers/index.js";
import { CANCEL_RFQ_REQUEST, CREATE_RFQ_QUOTE, GET_RFQ_QUOTES, GET_RFQ_BEST_QUOTE, CANCEL_RFQ_QUOTE, CREATE_RFQ_REQUEST, RFQ_CONFIG, GET_RFQ_REQUESTS, RFQ_REQUESTS_ACCEPT, RFQ_QUOTE_APPROVE, } from "./endpoints.js";
...
export class RfqClient {
    ...
    async getRfqRequests(params) {
        ...
        const headers = await createL2Headers(this.deps.signer, this.deps.creds, l2HeaderArgs, this.deps.useServerTime ? await this.deps.getServerTime() : undefined);
        return this.deps.get(`${this.deps.host}${endpoint}`, { headers, params: parseRfqRequestsParams(params) });
    }
    /**
    ...
    async getRfqQuotes(params) {
        ...
        const headers = await createL2Headers(this.deps.signer, this.deps.creds, l2HeaderArgs, this.deps.useServerTime ? await this.deps.getServerTime() : undefined);
        return this.deps.get(`${this.deps.host}${endpoint}`, { headers, params: parseRfqQuotesParams(params) });
    }
    /**
    ...
    async acceptRfqQuote(payload) {
        this.ensureL2Auth();
        const rfqQuotes = await this.getRfqQuotes({
